...
const mixed4ChartOptions = {
  ...
  colors: [getLocalStorageItem('color-primary','#00009f'),getLocalStorageItem('color-secondary','#626262'), '#0AB964'],
  yaxis: {
    title: {
      text: '',
    },
