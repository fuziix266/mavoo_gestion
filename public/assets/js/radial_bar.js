...
const radialBar1Options = {
  ...
  labels: ['Cricket'],
  colors: [getLocalStorageItem('color-primary','#00009f')],
  responsive: [{
    breakpoint: 567,
    options: {
      chart: {
...
const radialBar2Options = {
  ...
  responsive: [{
    ...
    colors: [hexToRGB(getLocalStorageItem('color-primary', '#00009f'), 1)],
};
...
const radialBar3Options = {
  ...
  colors: [getLocalStorageItem('color-primary','#00009f'), '#0AB964',getLocalStorageItem('color-secondary','#626262'), '#E14E5A'],
