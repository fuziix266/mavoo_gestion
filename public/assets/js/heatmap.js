...
const heatmap1ChartOptions = {
  ...
  colors: [getLocalStorageItem('color-primary','#00009f'),getLocalStorageItem('color-secondary','#626262'),"#0AB964","#E14E5A","#F9C123","#4196FA","#C8B9D2","#28232D"],
  title: {
    text: ''
  },
  xaxis: {
...
const colors = [getLocalStorageItem('color-primary','#00009f'),getLocalStorageItem('color-secondary','#626262'),"#0AB964","#E14E5A","#F9C123","#4196FA","#C8B9D2","#28232D"]
    ...
    heatmap: {
      ...
      colorScale: {
        ranges: [{
          ...
          to: 5,
          name: 'low',
          color: getLocalStorageItem('color-primary','#00009f')
        },
          {
            from: 6,
            to: 20,
