...
Chart.defaults.font.family = "Rubik, serif";
...
new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
            label: "Dataset #1",
            backgroundColor: hexToRGB(getLocalStorageItem('color-primary','#00009f'),0.2),
            borderColor: hexToRGB(getLocalStorageItem('color-primary','#00009f'),1),
            borderWidth: 2,
            borderRadius: 5,
            borderSkipped: false,
...
new Chart(chart1, {
    ...
    data: {
        ...
        datasets: [{
            label: "Dataset #1",
            backgroundColor: hexToRGB(getLocalStorageItem('color-primary','#00009f'),0.5),
            borderColor: hexToRGB(getLocalStorageItem('color-primary','#00009f'),1),
            data: [-65, 59, -20, 81, 56, -55, 40]
        },
            {
        ...
        datasets: [
            {
                label: "Dataset #1",
                backgroundColor: [
                    hexToRGB(getLocalStorageItem('color-primary','#00009f'),0.5),
...
new Chart(chart8, {
    ...
    data: {
        ...
        datasets: [
            {
                backgroundColor: [hexToRGB(getLocalStorageItem('color-secondary','#00009f'),0.10), hexToRGB(getLocalStorageItem('color-secondary','#00009f'))],
                data: [21, 79]
            },
            {
