...
const pie1Options = {
    ...
    colors: [getLocalStorageItem('color-primary','#00009f'),getLocalStorageItem('color-secondary','#626262'),'#0AB964','#E14E5A','#F9C123'],
...
const pie9Options = {
    ...
    markers: {
        colors: [
            getLocalStorageItem('color-primary', '#00009f'),
