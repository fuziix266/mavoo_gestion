...
/**
 * AuthService específico del módulo Reservas.
 *
 * Wrapper sobre el `Container('auth')` de Laminas donde `Auth\Service\AuthService`
 * guarda la identidad del usuario después del login.
 */
class AuthService
{
